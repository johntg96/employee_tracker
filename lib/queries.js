...
function addEmployee(firstName, lastName, manager_id, occupation_id, department_id) {
  return connection.promise().query('INSERT INTO employee (first_name, last_name, manager_id, occupation_id, department_id) VALUES (?, ?, ?, ?, ?)', [firstName, lastName, manager_id, occupation_id, department_id]);
}
